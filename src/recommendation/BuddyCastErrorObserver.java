package recommenderSystem.observers;
...
import recommenderSystem.method.AbstractMethod;
import recommenderSystem.overlay.BuddyCast;
  ...
  public boolean execute() {
    ...
    try {
      ...
      for (int i = 0; i < g.size(); i ++) {
        ...
        AbstractMethod userNode = (AbstractMethod) currentNode.getProtocol(apid);
